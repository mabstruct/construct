---
description: "Interactive domain configuration interview — populate domains.yaml and search-seeds.json. Use when user says 'add a domain', 'initialize domain', 'new research domain', or chained from workspace-init."
