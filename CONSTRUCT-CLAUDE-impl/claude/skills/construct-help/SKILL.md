---
description: "Context-aware next-step suggestion and command menu. Use on session start, when user says 'help', 'what can I do?', 'what's next?', or 'suggest something'."
