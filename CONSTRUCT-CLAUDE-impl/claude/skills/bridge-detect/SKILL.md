---
description: "Find connections across knowledge domains. Use when user says 'find connections across domains', 'bridge detection', 'cross-domain patterns', or during curation cycle."
allowed-tools: Read, Grep, Glob, Write, Edit, Bash(git add *), Bash(git commit *)
---
