---
description: "Build the CONSTRUCT views SPA (Vite production build). Use when user says 'build the views', 'rebuild views', 'compile views'. Run after views-scaffold or source changes."
