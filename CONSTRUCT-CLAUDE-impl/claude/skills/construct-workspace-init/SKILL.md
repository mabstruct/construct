---
description: "Initialize a CONSTRUCT workspace (create domain subdirectory with cards/, refs/, connections, etc.). Use when user says 'initialize workspace', 'initialize [domain]', 'construct init', 'set up a knowledge workspace'."
