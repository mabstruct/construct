...
6. **Concurrent direct invocations.** Deferred intentionally. The current Claude-native app architecture is experimental, and concurrency-safe debounce state is not worth the complexity yet. Revisit during future improvements / consolidation work or after the runtime architecture changes.
