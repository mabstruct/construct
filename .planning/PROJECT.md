...
**v0.4.1 Surface Integration & Documentation Truth** (see Current Milestone above). Three open requirements: DOC-01/02 (architecture doc set) and UX-01 (`daily.run` entry point) — all Phase 17. FIX-04 (doc-command guard) delivered 2026-07-19; DOC-03 and FIX-02 closed by Phase 14 (2026-07-19); FIX-01 closed by Phase 15 (2026-07-20); FIX-03, DEC-01, and DOC-04 closed by Phase 16 (2026-07-25).
...
---
*Last updated: 2026-07-25 — Phase 16 (Invocation & User-Doc Truth) complete; FIX-03, DEC-01, DOC-04 validated — `_KNOWN_BROKEN` empty over a widened guard, `knowledge card list` shipped, synthesis tool-grants closed, user doc set made executable and human-verified*
