...
This roadmap hardens CONSTRUCT's Claude-native foundation first, then establishes the v0.3 runtime spine, then adds bounded graph leverage and v0.5-facing contracts without pulling full browser UI work ahead of proven backend and workflow behavior.
...
- [x] **Phase 6: Derived Data, Ops UI & Governed Spikes** - Prepare v0.5-facing contracts and evaluate local UI/graph-analysis spikes without changing canonical truth. (completed 2026-06-11)
