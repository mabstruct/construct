# Requirements Archive: v0.3 Claude-Native Runtime & Workflow Hardening
...
Requirements for the first committed roadmap scope, which in this repository maps to the v0.3 implementation and hardening path while preserving a clean v0.5 UI trajectory.
...
- **EXP-01**: User can browse and operate the product primarily through a broader-user **v0.5** UI shell built on top of the hardened v0.4 workflow runtime.
...
| Feature | Reason |
|---------|--------|
| Full v0.5 browser-first product shell | v0.4 agent workflows must land before UI-primary delivery |
