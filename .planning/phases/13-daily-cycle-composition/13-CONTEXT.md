...
- **D-03:** **`escalate` / undecided items are NEVER auto-written** — they stay pending at the child's gate (checkpoint persisted) for optional human review. This is the safety valve for genuinely ambiguous cases (mirrors D-07 "no default write for escalate").
