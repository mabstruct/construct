...
const TIMELINE_DATA = [
  ...
  { year: 2026, 'embodied-ai': 6, 'perception-detection': 1, 'agentic-systems': 4, 'spatial-understanding': 4, 'intent-to-action': 5, 'indoor-world-model': 4, 'causal-world-models': 2, 'agentic-robot-middleware': 5, 'vision-language': 3, total: 34 }
]
  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        {[
          { label: 'Total Entries', value: '190+', sub: '27 daily digests · 13 clusters', color: 'violet' },
          { label: 'Research Clusters', value: '13', sub: 'Search pattern v6 · weighted', color: 'cyan' },
